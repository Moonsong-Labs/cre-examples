export const ASSETS = ["BTC", "ETH", "LINK", "sDAI", "SHIB"] as const;
...
export const MOCK_METRICS = {
	...
	count: 30,
	idx: 0,
	volBps: [4500n, 5200n, 6800n, 50n, 12000n] as readonly bigint[],
	corrBps: [
		8500n, 7200n, 500n, 6000n, 7800n, 300n, 5500n, 200n, 4800n, 100n,
	] as readonly bigint[],
};
